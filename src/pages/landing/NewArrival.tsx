...
import { IProduct } from '../shop/products';

export const NewArrival = () => {
  const [products, setProducts] = useState<IProduct[]>([]);

  const fetchProducts = async () => {
    const { data } = await axios.get(`/api/v1/shop?sort=latest-arrival&paginate=4`);
  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="text-2xl font-bold tracking-tight text-center text-gray-900">NEW ARRIVALS</h2>
